...
export class AlphabetGeneratorComponent implements OnInit {
  ...
  TeluguWordList = ["అరటి","ఆరు","ఇల్లు ","ఈక ","ఉంగరం","ఊడ ","ఋతువు","ౠ","ఎలుక ","ఏనుగు ","ఐదు","ఒర","ఓడ ","ఔషధము","0","0","0","అంకెలు ","అంతఃపురము ","0","0","0","కలం","ఖడ్గము","గంప","ఘటము","వాఙ్మయం","0","0","చక్రము","పింఛము","జడ","ఝషము ","జ్ఞాపిక","0","0","టపాకాయ","కంఠము","డబ్బు","ఢంకా","వీణ","0","0","తలుపు","పథము","దండ","ధనుస్సు","నగ","0","0","పలక ","ఫలము","బంతి","భజన"
  , "మంచము","0","యజ్ఞము","రవి","లవంగం","వంకాయ","శరము","షట్పదము"
  ,"0","0","సబ్బు","హంస","తాళం","వృక్షము","ఱంపము","0"];
